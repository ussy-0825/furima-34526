class Orderdelivery
  ...
  attr_accessor :postal_code, :prefectures_id, :city, :address, :building, :phone, :user_id, :item_id, :token
  ...
  def save
    ...
    Delivery.create(postal_code: postal_code, prefectures_id: prefectures_id, city: city, address: address, building: building,
